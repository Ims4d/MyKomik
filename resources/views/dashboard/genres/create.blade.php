...
@section('page-title', 'Create New Genre')

@section('content')
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-bold text-white">Create a New Genre</h2>
    ...
    <div class="max-w-xl mx-auto">
        <form action="{{ route('dashboard.genres.store') }}" method="POST" class="space-y-6">
            @csrf
